...
func SignUp() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		token, refreshToken, _ := helpers.GeneraterAllTokens(*user.Email, *user.First_name, *user.Last_name, user.User_id)
		user.Token = &token
...
func Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		token, refreshToken, _ := helpers.GeneraterAllTokens(*foundUser.Email, *foundUser.First_name, *foundUser.Last_name, foundUser.User_id)
